...
SESSION_CONFIGS = [
    ...
    dict(
        name="game_NoR",
        display_name="Problems with no recommendations",
    ...
    dict(
        name="game_R_Random",
        display_name="Problems with random recommendations",
        app_sequence=["binary_choice_game"],
        num_demo_participants=1,
        treatments=["R_Random"],
    ),
    dict(
        name="game_R_Maj",
        display_name="Problems with recommendations based on most popular choice",
        app_sequence=["binary_choice_game"],
        num_demo_participants=1,
        treatments=["R_Maj"],
    ),
    dict(
        name="game_R_CF",
        display_name="Problems with recommendations generated by user-based collaborative filtering",
        app_sequence=["binary_choice_game"],
        num_demo_participants=1,
        treatments=["R_CF"],
    ),
    dict(
        name="game_R_CBF",
        display_name="Problems with recommendations generated by content-based filtering using random forest",
        app_sequence=["binary_choice_game"],
        num_demo_participants=1,
        treatments=["R_CBF"],
    ),
